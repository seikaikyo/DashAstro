...
import SummaryCard from '../components/sukuyodo/SummaryCard.vue'
import FortuneTab from '../components/sukuyodo/FortuneTab.vue'
import MatchTab from '../components/sukuyodo/MatchTab.vue'
import LuckyDaysTab from '../components/sukuyodo/LuckyDaysTab.vue'
import KnowledgeTab from '../components/sukuyodo/KnowledgeTab.vue'
