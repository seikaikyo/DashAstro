...
<template>
  <section class="knowledge-tab">
    ...
    <!-- My Mansion -->
    <div v-if="activeTab === 'mansion'" class="knowledge-content" role="tabpanel">
    ...
    <!-- Wheel -->
    <div v-if="activeTab === 'wheel'" class="knowledge-content" role="tabpanel">
      <MansionWheel
    ...
    <!-- Relations -->
    <div v-if="activeTab === 'relations'" class="knowledge-content" role="tabpanel">
    ...
    <!-- Elements -->
    <div v-if="activeTab === 'elements'" class="knowledge-content" role="tabpanel">
    ...
    <!-- Calendar -->
    <div v-if="activeTab === 'calendar'" class="knowledge-content" role="tabpanel">
    ...
    <!-- History -->
    <div v-if="activeTab === 'history'" class="knowledge-content" role="tabpanel">
