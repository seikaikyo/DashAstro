...
<template>
  <section class="match-tab">
    ...
    <!-- Finder -->
    <div v-if="activeTab === 'finder'" class="match-content" role="tabpanel">
    ...
    <div v-if="activeTab === 'compat'" class="match-content" role="tabpanel">
    ...
    <!-- Partners -->
    <div v-if="activeTab === 'partners'" class="match-content" role="tabpanel">
