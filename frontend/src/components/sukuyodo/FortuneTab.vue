...
<template>
  <section class="fortune-tab">
    ...
    <!-- Daily Fortune -->
    <div v-if="activeTab === 'daily'" class="fortune-content" role="tabpanel">
    ...
    <!-- Weekly Fortune -->
    <div v-if="activeTab === 'weekly'" class="fortune-content" role="tabpanel">
    ...
    <!-- Monthly Fortune -->
    <div v-if="activeTab === 'monthly'" class="fortune-content" role="tabpanel">
    ...
    <!-- Yearly Fortune -->
    <div v-if="activeTab === 'yearly'" class="fortune-content" role="tabpanel">
